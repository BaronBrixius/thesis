...
class Experiment:
    ...
    def run_one_simulation(self, num_nodes, num_connections, output_dir, num_steps, display_interval, metrics_interval, random_seed, color_by=ColorBy.ACTIVITY):
    ...
    def run_experiment(self, seed_range, nodes_range, connections_range, num_steps, display_interval, metrics_interval, color_by=ColorBy.ACTIVITY):
        ...
        with ProcessPoolExecutor(max_workers=os.cpu_count()) as executor:
            ...
            for num_nodes, num_connections, seed in product(nodes_range, connections_range, seed_range):
                ...
                simulation_dir = os.path.join(self.experiment_folder, f"seed_{seed}", f"nodes_{num_nodes}", f"edges_{num_connections}")
