...
class Experiment:
    ...
    def run_one_simulation(self, num_nodes, num_edges, simulation_dir, num_steps, display_interval, metrics_interval, random_seed, color_by, process_num=0):
        ...
        sim = Simulation(num_nodes=num_nodes, num_edges=num_edges, simulation_dir=simulation_dir, color_by=color_by, random_seed=random_seed, process_num=process_num)
