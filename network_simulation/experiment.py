...
class Experiment:
    ...
    def monitor_input_early_termination(self):
        ...
        while True:
            ...
            if user_input in {"quit", "exit"}:
                ...
                print("Termination signal received. Slow-stopping experiment...")
                break
    ...
    def run_simulation(self, num_nodes, num_connections, output_dir, num_steps, display_interval, metrics_interval, random_seed, color_by=ColorBy.ACTIVITY):
        ...
        print(f"Simulation starting for {num_nodes} nodes, {num_connections} connections with seed {random_seed}")
