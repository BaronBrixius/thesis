from graph_tool.all import Graph, local_clustering, shortest_distance, label_components
...
class Metrics:
    ...
    def calculate_clustering_coefficient(graph):
        ...
        """
        return np.mean(local_clustering(graph).a)
    ...
    def calculate_rich_club_coefficient(graph):
        ...
        """
        # Placeholder as graph-tool does not natively provide this metric
        return None
