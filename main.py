...
if __name__ == "__main__":
    ...
    ## Quick Run
    # Experiment(base_dir).run_one_simulation(num_nodes=200, num_connections=3900, simulation_dir="racing2", 
    #                                     num_steps=200000, display_interval=1000, metrics_interval=1000, random_seed=42, color_by=ColorBy.CLUSTER)
